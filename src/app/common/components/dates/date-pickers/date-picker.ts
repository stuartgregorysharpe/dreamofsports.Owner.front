...
export abstract class CDatePicker<T> {
    ...
    public onActivate(): void {
        ...
        this.calendarLeft = (btnLeft + this.calendarWidth > window.innerWidth && btnRight - this.calendarWidth > window.innerWidth - (btnLeft + this.calendarWidth)) ? 
